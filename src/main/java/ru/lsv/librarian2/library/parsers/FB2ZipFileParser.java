...
/**
 * Класс обработчика zip-архива с fb2 книгами<br/>
 * Тянуто из Librarian
 * 
 * @author s.lezhnev
 */
public class FB2ZipFileParser {
	...
	private List<FileParserListener> listeners = Collections
			.synchronizedList(new ArrayList<FileParserListener>());
	...
	/**
	 * Парсинг zip-файла с fb2 книгами На текущий момент в нем должны лежать
	 * файлы вида XXXXXXXX.fb2, где XXXXXXX - цифровой код книги, который будет
	 * сохранен в базу
	 * 
	 * @param pathToFile
